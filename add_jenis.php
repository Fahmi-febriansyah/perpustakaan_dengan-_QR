...
if (isset($_POST['submit'])) {
	$harga = $_POST['harga'];
	$ubah = mysqli_query($koneksi,"INSERT INTO jenis VALUES('','$harga')");
	if ($ubah) {
			...
			<div class="card" style=" width: 600px;">
				<div class="card-header" style=" background-color:#00a98f; color: white; float: left; ">
					<div class="row">
						...
						<div class="col-sm-12 pt-2"><h5 align="center">Tambah jenis</h5></div>
						...
						<div class="col-sm-12">
							<form method="POST">
								<div class="form-group">
									<label for="exampleInputPassword1">masukan jenis</label>
									<input type="text" required name="harga" class="form-control" id="exampleInputPassword1">
								</div>
