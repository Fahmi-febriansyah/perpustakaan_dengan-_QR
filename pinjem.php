					...
					<tbody>
						...
						while ($data = mysqli_fetch_assoc($query)){ ?>
							<tr>
								...
								<td><a href="hapuscart.php?id=<?php echo $data['id_cart'] ?>"><button type="button" class="btn btn-primary">Hapus</button></a></td>
							</tr>
							<?php $tambah++; ?>
						<?php } ?>
					</tbody>
				...
				<center>
					...
					<form method="POST" action="action.php">
						<div class="form-group">
							<input type="date" required="" class="form-control" name="tanggal" id="exampleInputPassword1">
						</div>
						<hr>
...
<script>
	...
	scanner.addListener('scan', function(content){
		...
		function pindah(){
			top.location.href="tambah.php?id="+id
		}
